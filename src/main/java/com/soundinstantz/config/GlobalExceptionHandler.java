...
import com.soundinstantz.application.dto.common.BaseResponse;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<Object> handleUnauthorizedException(org.springframework.security.access.AuthorizationServiceException ex) {
        BaseResponse<Object> response = new BaseResponse<>();
        response.setSuccess(Const.ResultCode.ERROR);
        response.setMessage(ex.getMessage());
        return buildResponseEntity(response, HttpStatus.UNAUTHORIZED);
    }
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(org.springframework.web.servlet.NoHandlerFoundException ex) {
        BaseResponse<Object> response = new BaseResponse<>();
        response.setSuccess(Const.ResultCode.ERROR);
        response.setMessage("The requested URL " + ex.getRequestURL() + " was not found");
